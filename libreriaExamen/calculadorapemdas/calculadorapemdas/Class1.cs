...
namespace calculadorapemdas
{
    public class PEMDAS
    {
        public double PemdasCalcular()
        {
            string CalcularExpresion(string expresion)
            {
            ...
            string ParseText(string input, List<char> caracteresAceptados)
            {
            ...
            bool RevisarEjercicio(string ejercicio)
            {
            ...
            string CorregirReglaDeSignos(string ejercicio)
            {
            ...
            ejercicio = CorregirReglaDeSignos(ejercicio);
            ...
            {
                // Se interrumpe la función si el ejercicio no es válido
                Console.WriteLine("El ejercicio no es válido. Corrija el ejercicio e intente de nuevo.");
                return(0);
            }
            ...
            foreach (KeyValuePair<char, string> subEjercicio in diccionarioSubEjercicios)
            {
                ...
                ejercicio = ejercicio.Replace(subEjercicio.Key.ToString(), CalcularExpresion(subEjercicio.Value));
            }
            ...
            double resultado = Convert.ToDouble(CalcularExpresion(ejercicio));
